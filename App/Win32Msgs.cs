...
namespace _2ndbrainalpha
{
    class Win32Msgs
    {
        static Dictionary<int, string> _win32Msgs = new Dictionary<int, string> {
            {0,"WM_NULL"},
            {1,"WM_CREATE"},
            {2,"WM_DESTROY"},
            {3,"WM_MOVE"},
        ...
        public static string GetMsgName(int msgNumber)
        {
            if (_win32Msgs != null && _win32Msgs.ContainsKey(msgNumber))
            {
                return _win32Msgs[msgNumber];
            }
            return string.Empty;
        }
    }
